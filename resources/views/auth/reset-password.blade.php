...
<head>
    ...
    <title>Atur Ulang Kata Sandi - Balmon Lampung Monitoring</title>
    ...
    <style>
        ...
        .reset-header h1 { font-size: 1.5rem; font-weight: 800; color: var(--balmon-navy); margin-bottom: 0.5rem; }
        .reset-header p { color: var(--balmon-slate); font-size: 0.875rem; font-weight: 500; }
        ...
        .input-group-modern .form-control:disabled {
            background-color: #f8fafc;
            color: var(--balmon-slate);
        }
...
<body>
    <!-- Latar Belakang Cahaya Biru (Sama persis seperti halaman Login) -->
    ...
    <main class="reset-card">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group-modern">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Ulangi sandi baru" required>
