...
@section('title', 'Data Rutin')
@section('page_title', 'Rutin')

@section('content')
<div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
    <h2 class="h5 m-0">Data Rutin</h2>
    <div class="d-flex gap-2">
        <a href="{{ route('export.rutin', ['file' => $sourceFile]) }}" class="btn btn-success">Export Rutin</a>
    </div>
</div>
...
@include('partials.hasil-pilah-ringkasan', ['activeType' => 'rutin'])
