...
@section('title', 'Data Medium Frekuensi')
@section('page_title', 'Medium Frekuensi')

@section('content')
<div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
    <h2 class="h5 m-0">Data Medium Frekuensi</h2>
    <div class="d-flex gap-2">
        <a href="{{ route('export.mf', ['file' => $sourceFile]) }}" class="btn btn-success">Export MF</a>
    </div>
</div>
...
@include('partials.hasil-pilah-ringkasan', ['activeType' => 'mf'])
